...
public class Card_Feed_Adapter extends RecyclerView.Adapter<Card_Feed_Adapter.CardViewHolder>{
    private static final String TAG = "MyActivity";
    ArrayList<Card_Feed> tweets;
    Context context;

    public Card_Feed_Adapter(ArrayList<Card_Feed> tweets, Context context){
        this.tweets = tweets;
    ...
    @Override
    public void onBindViewHolder(final Card_Feed_Adapter.CardViewHolder feedCardView, int i) {
    ...
    @Override
    public Card_Feed_Adapter.CardViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_tweet, viewGroup, false);
        return new Card_Feed_Adapter.CardViewHolder(v);
    }
