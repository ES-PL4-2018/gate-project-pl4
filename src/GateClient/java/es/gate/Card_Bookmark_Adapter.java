...
public class Card_Bookmark_Adapter extends RecyclerView.Adapter<Card_Bookmark_Adapter.CardViewHolder>{
    private static final String TAG = "MyActivity";
    ArrayList<Card_Bookmark> bookmarks;
    Context context;
    Card_Bookmark_Adapter parent;

    Card_Bookmark_Adapter(ArrayList<Card_Bookmark> bookmarks, Context context){
