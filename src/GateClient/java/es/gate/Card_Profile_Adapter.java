...
public class Card_Profile_Adapter extends RecyclerView.Adapter<Card_Profile_Adapter.CardViewHolder>{
    ...
    public Card_Profile_Adapter(List<Card_Interests> interests){
